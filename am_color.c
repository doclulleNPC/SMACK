...
extern int automap_textured; // textured (floor-flat) automap display
...
VARIABLE_BOOLEAN(automap_textured, NULL, onoff);
...
CONSOLE_VARIABLE(automap_textured, automap_textured, 0) {}
