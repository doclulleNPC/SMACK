...
#include "doomstat.h"
#include "m_random.h"
#include "tables.h"   // mbf21: FixedToAngle, finetangent
...
//
// mbf21: hitscan spread helpers
//
// From Woof (src/m_random.c:144), which took them from Eternity, so that
// mbf21 attacks consume the RNG in the same order everywhere.
//

//
// P_RandomHitscanAngle
// Outputs a random angle between (-spread, spread), as an int (it can be negative).
