...
default_t defaults[] = {
...

  {
    ...
    (intptr_t)"player", {0}, dt_string, ss_none, wad_no,
...
*/
  ...
  { // killough 2/21/98: default to 10
    ...
    "screensize",
    &screenSize, NULL,
    7, {0,11}, dt_number, ss_none, wad_no,
    "screen size (8 fullscreen, 9 GZDoom HUD, 10 HUD 50%, 11 bar 50%)"
  },
  ...
  { // killough 10/98: preloaded files
    ...
    (intptr_t)"", {0}, dt_string, ss_none, wad_no,
...

  {
    ...
    (intptr_t)HUSTR_CHATMACRO0, {0}, dt_string, ss_chat, wad_yes,
...

  {
    ...
    (intptr_t)HUSTR_CHATMACRO1, {0}, dt_string, ss_chat, wad_yes,
...

  {
    ...
    (intptr_t)HUSTR_CHATMACRO2, {0}, dt_string, ss_chat, wad_yes,
...

  {
    ...
    (intptr_t)HUSTR_CHATMACRO3, {0}, dt_string, ss_chat, wad_yes,
...

  {
    ...
    (intptr_t)HUSTR_CHATMACRO4, {0}, dt_string, ss_chat, wad_yes,
...

  {
    ...
    (intptr_t)HUSTR_CHATMACRO5, {0}, dt_string, ss_chat, wad_yes,
...

  {
    ...
    (intptr_t)HUSTR_CHATMACRO6, {0}, dt_string, ss_chat, wad_yes,
...

  {
    ...
    (intptr_t)HUSTR_CHATMACRO7, {0}, dt_string, ss_chat, wad_yes,
...

  {
    ...
    (intptr_t)HUSTR_CHATMACRO8, {0}, dt_string, ss_chat, wad_yes,
...

  {
    ...
    (intptr_t)HUSTR_CHATMACRO9, {0}, dt_string, ss_chat, wad_yes,
  ...
  {
    "automap_textured",
    &automap_textured, NULL,
    1, {0,1}, dt_number, ss_auto, wad_no,
    "textured (floor-flat) automap display"
  },
...
void M_LoadDefaults (void)
{
  ...
  for (dp = defaults; dp->name; dp++)
    if (dp->isstr)
      // 64-bit: store the full pointer, not a truncated (int) cast
